...
public class MessageBatchException extends TException implements org.apache.thrift.TBase<MessageBatchException, MessageBatchException._Fields>, java.io.Serializable, Cloneable, Comparable<MessageBatchException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MessageBatchException");
  ...
  static {
    schemes.put(StandardScheme.class, new MessageBatchExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MessageBatchExceptionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MessageBatchException.class, metaDataMap);
  }

  public MessageBatchException() {
  }
   ...
   */
  public MessageBatchException(MessageBatchException other) {
    if (other.isSetWhat()) {
  ...
  public MessageBatchException deepCopy() {
    return new MessageBatchException(this);
  }
  ...
  public MessageBatchException setWhat(String what) {
    this.what = what;
    return this;
  }
  ...
  public MessageBatchException setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  public MessageBatchException setWho(String who) {
    this.who = who;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MessageBatchException)
      return this.equals((MessageBatchException)that);
    return false;
  }

  public boolean equals(MessageBatchException that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MessageBatchException other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MessageBatchException(");
    boolean first = true;
  ...
  private static class MessageBatchExceptionStandardSchemeFactory implements SchemeFactory {
    public MessageBatchExceptionStandardScheme getScheme() {
      return new MessageBatchExceptionStandardScheme();
    }
  }

  private static class MessageBatchExceptionStandardScheme extends StandardScheme<MessageBatchException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MessageBatchException struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageBatchException struct) throws TException {
      struct.validate();
  ...
  private static class MessageBatchExceptionTupleSchemeFactory implements SchemeFactory {
    public MessageBatchExceptionTupleScheme getScheme() {
      return new MessageBatchExceptionTupleScheme();
    }
  }

  private static class MessageBatchExceptionTupleScheme extends TupleScheme<MessageBatchException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MessageBatchException struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MessageBatchException struct) throws TException {
