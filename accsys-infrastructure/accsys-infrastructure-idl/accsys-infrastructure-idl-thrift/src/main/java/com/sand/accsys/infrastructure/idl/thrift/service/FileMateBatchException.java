...
public class FileMateBatchException extends TException implements org.apache.thrift.TBase<FileMateBatchException, FileMateBatchException._Fields>, java.io.Serializable, Cloneable, Comparable<FileMateBatchException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FileMateBatchException");
  ...
  static {
    schemes.put(StandardScheme.class, new FileMateBatchExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FileMateBatchExceptionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FileMateBatchException.class, metaDataMap);
  }

  public FileMateBatchException() {
  }
   ...
   */
  public FileMateBatchException(FileMateBatchException other) {
    if (other.isSetWhat()) {
  ...
  public FileMateBatchException deepCopy() {
    return new FileMateBatchException(this);
  }
  ...
  public FileMateBatchException setWhat(String what) {
    this.what = what;
    return this;
  }
  ...
  public FileMateBatchException setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  public FileMateBatchException setWho(String who) {
    this.who = who;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FileMateBatchException)
      return this.equals((FileMateBatchException)that);
    return false;
  }

  public boolean equals(FileMateBatchException that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FileMateBatchException other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FileMateBatchException(");
    boolean first = true;
  ...
  private static class FileMateBatchExceptionStandardSchemeFactory implements SchemeFactory {
    public FileMateBatchExceptionStandardScheme getScheme() {
      return new FileMateBatchExceptionStandardScheme();
    }
  }

  private static class FileMateBatchExceptionStandardScheme extends StandardScheme<FileMateBatchException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FileMateBatchException struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileMateBatchException struct) throws TException {
      struct.validate();
  ...
  private static class FileMateBatchExceptionTupleSchemeFactory implements SchemeFactory {
    public FileMateBatchExceptionTupleScheme getScheme() {
      return new FileMateBatchExceptionTupleScheme();
    }
  }

  private static class FileMateBatchExceptionTupleScheme extends TupleScheme<FileMateBatchException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FileMateBatchException struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FileMateBatchException struct) throws TException {
